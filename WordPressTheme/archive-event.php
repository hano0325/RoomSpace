    ...
    <section class="event-lower event-lower-layout">
        <div class="event-lower__inner inner">
            <div class="event-lower__tab tab">
                <div class="tab__list">
                    <?php
                    $is_archive_page = is_post_type_archive('event');
                    ...
                    <a class="tab__button <?php echo $is_archive_page ? 'is-active' : ''; ?>"
                        href="<?php echo esc_url(get_post_type_archive_link('event')); ?>">ALL</a>
                    <?php if (!empty($terms)) : foreach ($terms as $term) : ?>
                    <a class="tab__button <?php echo is_tax('event_category', $term->slug) ? 'is-active' : ''; ?>"
